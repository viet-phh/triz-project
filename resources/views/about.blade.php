...
<main>
    ...
    <section class="section gray-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-15px-tb">
                        <h3 class="h1 m-20px-b">Unlimited power and customization possibilities.</h3>
                        <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos non quo dolore esse alias porro</p>
                        <div class="p-20px-tb">
                    ...
                    <div class="col-lg-5 col-xl-4 ml-lg-auto align-self-center m-15px-tb">
                        <div class="accordion accordion-08 p10 border-radius-15 dark-bg white-color links-white">
                            ...
                            <div class="acco-group">
                                <a href="#" class="acco-heading">Title Skill/Certificate</a>
                                <div class="acco-des">Adipisicing elit lorem ipsum dolor sit amet, consectetur. Tempora, ab officiis ducimus commodi</div>
                            </div>
                            <div class="acco-group">
                                <a href="#" class="acco-heading">Title Skill/Certificate</a>
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 m-15px-tb">
                    <img src="{{asset('homepage/img/ai-2.svg')}}" title="" alt="">
                </div>
                <div class="col-lg-6 m-15px-tb">
                    <div class="p-45px-l lg-p-0px-l">
                        <h3 class="h2 m-15px-b">Stay focused on your business. Let us handle the design.</h3>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 m-15px-tb">
                    <div class="row">
                        <div class="col-6">
                            <div class="overflow-hidden border-radius-5 box-shadow">
                                <img src="{{asset('homepage/img/ai-4.png')}}" title="" alt="">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="overflow-hidden border-radius-5 box-shadow">
