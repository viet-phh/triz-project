...
<main>
    ...
    <section class="effect-section theme-bg parallax" style="background-image: url(homepage/img/bg-1.jpg);">
        ...
        <!-- <div class="effect-1 opacity-8">
            <img src="{{asset('homepage/img/effect/style-1.svg')}}" title="" alt="" class="svg_img theme2nd-color">
        </div>
        ...
        <div class="container">
            ...
            <div class="tab-style-5">
                <div class="row justify-content-center m-35px-b">
                    <div class="col-lg-10">
                        <ul class="nav nav-fill nav-tabs">
                            <li class="nav-item">
                                <a href="#tab5__sec0" data-toggle="tab" class="nav-link active box-shadow-lg">
                                    <span>Dịch vụ</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#tab5__sec1" data-toggle="tab" class="nav-link  box-shadow-lg">
                                    <span>Lean</span>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="tab-content">
                    <!-- start tab content -->
                    <div id="tab5__sec0" class="tab-pane fade in active show">
                        <div class="row align-items-center justify-content-around">
                            <div class="col-lg-5 m-15px-tb">
                                <h3 class="h1">Các sản phẩm của chúng tôi</h3>
                    ...
                    <!-- end tab content -->
                    <!-- start tab content -->
                    <div id="tab5__sec1" class="tab-pane fade in">
                        <div class="row align-items-center justify-content-around">
                            <div class="col-lg-5 m-15px-tb">
                                <label class="theme2nd-bg-alt font-small font-w-500 p-20px-lr p-5px-tb theme2nd-color border-radius-15 m-15px-b">Lean</label>
                    ...
                    <div class="row align-items-center justify-content-around">
                            <div class="col-lg-5 m-15px-tb">
                                <label class="theme2nd-bg-alt font-small font-w-500 p-20px-lr p-5px-tb theme2nd-color border-radius-15 m-15px-b">6Sigma</label>
                                <h3 class="h1">Lorem ipsum dolor</h3>
                                <p class="font-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis officia illum aliquid repellat quod neque.</p>
                                <ul class="list-type-03 theme2nd">
                                    <li>
                    ...
                    <div class="row align-items-center justify-content-around">
                            <div class="col-lg-5 m-15px-tb">
                                <label class="theme2nd-bg-alt font-small font-w-500 p-20px-lr p-5px-tb theme2nd-color border-radius-15 m-15px-b">Triz</label>
                                <h3 class="h1">Lorem ipsum dolor</h3>
                                <p class="font-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis officia illum aliquid repellat quod neque.</p>
                                <ul class="list-type-03 theme2nd">
                                    <li>
                ...
                <div class="col-lg-4 m-15px-tb">
                    <div class="card blog-grid-1">
                        ...
                        <div class="card-body blog-info">
                            ...
                            <div class="btn-bar">
                                <a class="m-link-theme2nd" href="#">Read more</a>
                            </div>
                        </div>
                    </div>
                </div>
